...
@Component({
  selector: 'app-block-03-cad',
  templateUrl: './app-block-03-cad.component.html',
  styleUrls: ['./app-block-03-cad.component.css'],
...
export class AppBlock03CadComponent implements OnInit {
  ...
  titleBlock: string = 'Желтая рубашка';
